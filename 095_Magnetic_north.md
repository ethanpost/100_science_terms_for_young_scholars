...
Your compass was not broken. You trusted it. So what went wrong?

You may have been following the wrong kind of north.

**Magnetic north** is one of the most useful directions in outdoor life — and one of the easiest to misunderstand. In the chapter on the **compass**, you learned how a needle finds direction. This chapter goes deeper: what "north" on that needle really means, how it differs from map north, and why smart navigators still miss campsites while staring at a needle that works perfectly.
...
In the **outer core**, hot liquid iron moves and churns. Electric currents and motion there create a planet-wide **magnetic field** that stretches far into space. You met this idea in the chapter on **magnetism**: magnets affect things without touching them. Earth's field is the biggest magnet you will ever use on a hike.
...
Near the ground, magnetic field lines run in huge loops. In a simplified picture, they emerge from southern polar regions and curve back into northern polar regions. A compass needle lines up with the **local** direction of that field — the way the invisible lines run near your feet.

The field is real. It is also not frozen in place forever.

![Earth's outer core acts like a giant magnet](095_Magnetic_north_02.png)
...
**Memory trick:** **MAG**netic north is what your **MAG**netized needle likes. **TRUE** north is what the **map** and the **North Pole** use.

![Your compass follows the horizontal part of the field](095_Magnetic_north_03.png)

## Magnetic North vs True North

Maps for serious navigation are usually built around a different north.

**True north** (also called **geographic north**) is the direction toward Earth's **North Pole** along Earth's rotation axis — the same axis you studied in the chapter on **rotation of the Earth**.
...
In some cities the difference is only a few degrees — easy to ignore on a short walk across a parking lot.

In other places it can be **15°, 20°, or more**. Ignore it on a long hike with a paper map and you can miss a landmark by hundreds of meters — or lose an orienteering race you were winning.

### How Far Off Can You Be?

Here is why declination matters in real distance, not just on paper.

Suppose you walk **5 kilometers** on a compass bearing, but you forgot to correct for **15°** of declination. Your path is a straight line — but it is aimed at the wrong place. The sideways "miss" is roughly:

**distance × sin(declination)**

For 5 km and 15°, that is about **5 × 0.26 ≈ 1.3 km** off to the side. That is more than a kilometer — farther than many campsites are from the trail you wanted.

You can look confident. You can walk in a perfectly straight line. You can still end up in the wrong valley.
...
![Walk straight on the wrong bearing and miss by over a kilometer](095_Magnetic_north_04.png)
...
Whenever students mix up map and compass work, experienced teachers ask one question: **"Which north?"**

![True north, magnetic north, and grid north can all differ](095_Magnetic_north_05.png)
...
![Earth's magnetic field drifts — declination values need updating](095_Magnetic_north_06.png)
...
### A Mini Field Example

You are in a place where declination is **10° west** (magnetic north sits west of true north). Your map says the trail to camp runs at **90° true** (due east).

You cannot just set your compass to 90° and walk. You must convert:

- Map bearing (true) → adjust for declination → compass bearing (magnetic)

With **10° west** declination, magnetic north is west of true north, so your compass bearing will differ from 90° by those 10°. Your teacher will show whether to add or subtract for your region's convention. The point is not the arithmetic trick — it is the habit: **never assume map degrees and compass degrees are the same number without checking.**

![Convert map bearings to compass bearings — do not assume the numbers match](095_Magnetic_north_07.png)
...
![Metal and phones can pull a compass needle off course](095_Magnetic_north_08.png)

## Magnetic North in the Real World

**Orienteering** runners set compass bearings between control points. One uncorrected declination can send you past a flag hidden behind a boulder while your rival punches the card and sprints on.

**Search and rescue** teams plot bearings on maps to sweep grids. A systematic error from declination wastes precious time.

**Sailors and pilots** file flight plans and chart courses using current declination data — wrong north can mean wrong runway or wrong channel.

**Scouts and camp counselors** teach "map north vs needle north" before anyone is allowed to lead a night hike.

**Geologists and surveyors** record field directions that must match published maps years later.

The pattern is the same everywhere: Earth's field gives you **magnetic north**. Human maps usually want **true north** or **grid north**. Your job is to translate between them.
...
A compass tells you direction. It does not tell you **where you are**, **what is in front of you**, or **whether a cliff is ahead**. Direction plus map plus landmarks plus common sense wins — the same lesson from the **compass** chapter, worth repeating here.
...
8. Approximately how far sideways could you miss a target if you walk 5 km with a 15° declination error? (Use the idea from the chapter.)
9. What is grid north, and why might it matter on some maps?
10. What is one cause of slow change in Earth's magnetic field?
11. Name two types of metal or objects that can pull a compass needle off course.
12. Why might a smartphone compass be unreliable indoors?
13. What is the difference between magnetic north and the geographic North Pole?
14. If you ignore declination on a long hike, what kind of error can happen?
15. Name one real-world activity where uncorrected declination could waste time or lose a race.
16. Name one thing scientists use to measure and model Earth's magnetic field.
17. Why is "magnetic north" not a single permanent spot that never moves?
18. True or false: A compass alone tells you exactly where you are on a map. Explain.
19. When converting between compass bearings and map bearings, what should you check on the map legend first?
20. In your own words, explain why a careful hiker might reach the wrong campsite even while following a compass needle that works perfectly.
