...
The map in your hand still shows the next checkpoint northeast of the stream crossing. But northeast of *what*? The trail forked twice. You are not sure which fork you took.

You pull a small compass from your pack. Hold it level. Wait. The needle swings, wobbles, and settles.

Suddenly you are not guessing. You have a tool that talks to something bigger than any trail sign — **Earth's own magnetic field.**
...
The classic pocket compass has a **magnetized needle** mounted so it can spin freely. When you hold the compass **level** and **still**, the needle aligns with Earth's magnetic field and points roughly toward **magnetic north** — the direction Earth's field pulls a horizontal compass at your location.

Markings around the dial — often on a rotating ring called the **housing** — let you read directions in degrees. With practice, a compass becomes a bridge between the **map in your hands** and the **land in front of you.**

**Memory trick:** A compass answers one question first — **"Which way is north from here?"** Everything else (east, west, your route) builds from that.

## Magnetism You Already Know

If you read the chapter on **magnetism**, you already know the basics: magnets have a **north pole** and a **south pole**, opposite poles attract, and like poles repel.

A compass needle is a **small magnet** sitting in a **planet-sized magnetic field.**

Earth behaves like a giant magnet. Its field stretches from deep inside the planet out into space — the same invisible field that helps create **auroras** near the poles and that the chapter on **magnetic north** explores in more detail.

The north-seeking end of the needle is pulled into alignment with the field lines around you. No satellite. No Wi-Fi. Just physics.

## The Confusing Part About "North" (Worth Getting Right)

Here is the part that confuses almost everyone at first:

The end of the needle marked **"N"** is attracted toward Earth's **magnetic south pole**, which sits near Earth's geographic **north** polar region.

That sounds backward. It is not magic — it is magnet rules. **Opposite poles attract.** The needle's north end is pulled toward the magnetic pole near the Arctic end of Earth. That is why we say the needle points "north." What we mean is: the labeled north end points generally toward the polar region we call north, along the direction of the magnetic field at your location.
...
|---|----------------|---------------------|
| What it is | Direction toward the **North Pole** along Earth's rotation axis | Direction a **compass needle** actually points |
| Set by | Earth's **spin** (axis) | Earth's **magnetic field** |
| On most maps | Often how "up" is drawn | What your needle follows |
| Same everywhere? | Yes — one geographic pole | **No** — shifts over time and place |
...
The angle between true north and magnetic north at a given place is called **magnetic declination**. Declination changes slowly over the years as Earth's magnetic field shifts. In some parts of the world it is only a degree or two. In others it can be **15° or more.**
...
Many maps show a **compass rose** — a symbol, often with arrows, that shows which way north is drawn on that map. Always check the rose before you assume "up" on a map is true north.

A **baseplate compass** — the kind hikers and orienteers use — has a clear plastic base, a rotating dial, and a **direction-of-travel arrow.** You can line up the edge of the compass with a direction on your map, twist the housing until the orienting lines match the map's north (with declination corrected if needed), and read a bearing off the dial. With practice, you can plan a route on paper and then walk it in the field.

## Types of Compasses

Not every compass looks like a pocket watch.

**Liquid-filled compass:** The needle floats in oil or another fluid. The fluid dampens bouncing so the needle settles faster — useful when you are walking or riding over rough ground.

**Baseplate compass:** Designed for map work. Has rulers, arrows, and a rotating housing for bearings. Standard gear for hiking, scouting, and **orienteering.**
...
**Digital compass:** Built into phones, watches, and GPS units. Uses electronic sensors instead of a free needle. Convenient — but it can be thrown off by the same metal and magnet interference as a classic compass. (Your phone's compass is not magic; it is still reading Earth's field.)
...
Compasses helped explorers reach new continents. They helped armies march in formation and rescue teams search grid patterns. The technology is ancient. The physics still matters in every serious science classroom — and in every backpack that plans to leave pavement.
...
4. Turn the housing until the orienting lines match the map's north (**true north** on the map), adjusting for **declination** if your map says to.
...
**Shadow and stick method (daytime):** On a sunny day, place a straight stick vertically in flat ground. Mark the tip of its shadow. Wait 15–20 minutes. Mark the new shadow tip. The line from the first mark to the second runs roughly **east–west** (the first mark is the west end in the Northern Hemisphere). A compass lets you check your work.

**Room bearing challenge:** Draw a simple map of a room. Pick two points. Use a compass to measure the bearing from one to the other. Have a partner verify. Discuss what happens if you hold the compass near a metal desk leg.

**Declination check:** Look up the current magnetic declination for your town (USGS and other geomagnetic tools publish this). Record whether magnetic north lies **east** or **west** of true north. That number is why "north on my phone map" and "north on my compass" are close cousins, not twins.

**Interference walk:** Walk slowly past a parked car, fence, or speaker. Log where the needle wobbles and how far you must step back for a stable reading.

**Orienteering mini-course:** Set five cones in a field or gym. Provide a simple map and compass bearings between points. Race for time or accuracy. Rule: **level compass, wait for the needle to settle.**
...
**Magnets** and strong **electrical currents** do the same. So can some speakers, motors, and even the **electromagnets** you studied in the chapter on electromagnets — current and magnetism are linked.
...
|-----------|---------|-----------|
| Battery dead | Still works | Often useless |
| Deep woods / canyon | Works if held away from metal | Signal may fail |
| Needs map + skill | Yes | Can show position on screen |
| Affected by nearby metal | Yes | Digital compass can too |
...
**Campers, hunters, and fishers** use them to find a cabin, blind, or campsite in the dark.

**Games and simulations** often use compass ideas too. A minimap with a north arrow, a survival game's heading readout, or a flight simulator's heading bug all borrow the same language: **degrees clockwise from north.**
...
A compass is a conversation between Earth's invisible magnetic field and a small magnet in your hand. Learning that conversation is one of the oldest survival skills humans ever invented — and one of the coolest physics tricks you can carry in your pocket.
...
22. Name one activity from the "Try This" section and what it teaches.
23. In your own words, explain why "the compass points north" is a useful shortcut but not the whole scientific story.
