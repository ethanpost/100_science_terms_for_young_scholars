...
That is the purpose of a thermometer.

**A thermometer is an instrument used to measure temperature.**

Thermometers help doctors check fevers, cooks prepare food safely, scientists run experiments, meteorologists report weather, engineers monitor machines, and families decide whether a room, oven, pool, or refrigerator is at the right temperature.
...
A thermometer does not measure heat directly. Heat is energy moving from warmer matter to cooler matter. Temperature is the measurement of hotness or coldness.

This difference matters.

A cup of boiling water has a higher temperature than a warm bathtub. But the bathtub may contain more total thermal energy because it has much more water.

The thermometer gives a temperature reading, not the total amount of thermal energy.

## Why Hands Are Poor Thermometers

Your skin can sense warmth and cold, but it is not a reliable measuring instrument.

Metal and wood at the same temperature can feel different because metal conducts thermal energy away from your hand faster. A swimming pool may feel cold at first and comfortable later because your body adjusts. A fever may feel different depending on the room, blankets, and your own condition.

Hands compare heat flow, not exact temperature.
...
The same principle appears in many other places. Bridges, sidewalks, railroad tracks, and metal lids all expand or contract when temperature changes.

## Digital Thermometers

A **digital thermometer** uses electronic parts to measure temperature.

Many digital thermometers contain a sensor whose electrical resistance changes with temperature. A small computer inside the thermometer turns that electrical change into a number on a screen.
...
A roast may have a hot surface and a cooler center. A forehead reading may be affected by sweat, wind, distance, or poor aim.
...
Normal human body temperature is often given as about **37 degrees Celsius** or **98.6 degrees Fahrenheit**, but it varies during the day and from person to person.
...
To measure air temperature well, the thermometer should be shaded from direct sunlight and placed where air can move around it. If a thermometer sits in bright sun, it may read too high because sunlight warms the thermometer itself.
...
The **Celsius** scale is used in science and in most of the world for everyday temperature.

The **Fahrenheit** scale is used in the United States for weather, body temperature, ovens, and everyday use.

The **Kelvin** scale is used in science, especially physics and chemistry. Kelvin starts at absolute zero, the lowest possible temperature.

A thermometer must show which scale it is using.
...
Fourth, include the unit in your answer. Writing "25" is incomplete. Writing "25 degrees Celsius" is clear.
...
A thermometer can be tested using known temperatures. For example, a mixture of ice and water should be close to 0 degrees Celsius under ordinary conditions. Boiling water should be close to 100 degrees Celsius at sea level under ordinary pressure.
...
A thermometer that reads 38.0 degrees Celsius every time when the true temperature is 37.0 degrees Celsius is precise but not accurate.

A thermometer that gives readings of 36, 38, and 37 degrees for the same object may be near the right value sometimes, but it is not very precise.
...
When ice melts in water, the mixture can stay near 0 degrees Celsius until much of the ice has melted. Heat energy is being used to change ice into liquid water rather than raising the temperature quickly.

When water boils under ordinary pressure at sea level, it stays near 100 degrees Celsius while boiling. Added energy changes liquid water into steam.
...
Cars use temperature sensors to help prevent engines from overheating. Computers use sensors to control fans and protect electronic parts. Refrigerators use thermostats to keep food cold. Ovens use temperature controls to cook food properly.
...
One common mistake is thinking a thermometer measures heat. It measures temperature, not heat directly.

Another mistake is thinking touch is more trustworthy than a thermometer. Touch can be fooled by heat transfer, surface material, and body condition.

A third mistake is reading a thermometer without checking the scale. Celsius and Fahrenheit numbers are very different.

A fourth mistake is assuming surface temperature and internal temperature are always the same.

A fifth mistake is thinking every thermometer can be used for every job. Medical, cooking, weather, infrared, and laboratory thermometers have different purposes and limits.
...
4. Why are hands poor thermometers?
...
26. What are three safety rules for using thermometers?
27. In your own words, explain why using the correct thermometer matters.
