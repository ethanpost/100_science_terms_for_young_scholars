...
1. **How far east or west** a place is around Earth from the prime meridian.
2. The **prime meridian** is the reference line for **0° longitude**; modern convention anchors it through the **Royal Observatory at Greenwich, England** (Greenwich meridian; WGS84 aligns with this tradition for classroom and GPS purposes).
3. **180°** east or west meet at the antimeridian (the opposite side of Earth from Greenwich).
4. A **meridian** is a line of constant longitude running **north–south** from pole to pole on a globe.
5. **Meridians** are all the same length (half-great circles through the poles) and converge at the poles. **Parallels** run east–west, shrink toward the poles, and only the equator is a great circle among parallels.
6. Earth rotates so different longitudes face the Sun at different times; societies group longitudes into **time zones** for shared clocks (with political adjustments).
7. Longitude at sea required accurate **timekeeping** (or equivalent methods) because position east–west is tied to time difference from a reference meridian; latitude could be found more directly from celestial altitude with period instruments.
8. About **15°** of longitude per **one hour** of rotation (360° in ~24 hours).
9. The **International Date Line** is a rough **180°** region where the **calendar date** often jumps when crossing east or west; it **zigzags** so nearby countries and islands can share practical calendar and trade arrangements.
10. **Latitude and longitude** (plus elevation when needed for full 3D precision).
...
18. **West** of Greenwich — **W** means west.
19. Accept reasonable answers, e.g., "Meridians are parallel east–west lines" is **false** — meridians run north–south and meet at the poles; or "The prime meridian is as natural as the equator" is **false** — the equator is spin-defined, the prime meridian is agreed.
20. Answers may vary. Strong answers: longitude gives east–west position only; you also need **latitude** for a full global address; together they fix a unique surface spot.
...
2. **Flight-Simulator or Map Drop**
   Enter lat/long pairs into a classroom mapping tool or flight sim. Compare how moving **1° east** at the equator vs near **60° N** changes ground distance — meridians squeeze toward the poles.

3. **Orange Meridian Marking**
   Draw the prime meridian on a citrus "Earth," label east vs west hemispheres, and mark **180°** on the opposite side. Discuss the date line as a calendar idea, not a physical wall.

4. **Longitude-from-Time Thought Experiment**
...
7. **Prime Meridian History Mini-Research**
   Short reports: Greenwich, earlier national meridians, and why charts had to agree. Keep focus on **safety at sea**, not memorizing treaty dates.

8. **Coordinate Dictation Race**
   Partners dictate lat/long pairs; listener plots on a paper map or digital globe. Penalize swapped lat/long — reinforces reading order and **E/W** labels.

9. **International Date Line Case Studies**
   Examine islands where the date line bends. Discuss why politics matters to calendars and why travelers can "lose" or "gain" a day.

10. **Rescue Coordinate Drill**
   Role-play: dispatch gives coordinates; students identify hemisphere (N/S, E/W) and nearest continent before opening the map — builds habit and urgency like real search-and-rescue work.
