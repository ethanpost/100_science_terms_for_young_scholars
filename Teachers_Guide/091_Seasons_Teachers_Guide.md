...
1. A **season** (astronomical) is a long stretch of the year when a region tends to have a certain kind of weather and daylight pattern tied to Earth's position in its orbit around the Sun.
2. A **sports season** is a block of games or practices (e.g., fall football); an **astronomical season** is Earth's yearly sunlight pattern (spring, summer, autumn, winter). They overlap in daily life but are not the same thing.
3. **Rotation** (spinning about once per day) and **revolution** (orbiting the Sun about once per year).
4. Earth's **axis** is the imaginary line through the North Pole and South Pole around which Earth rotates.
5. About **23.5 degrees**.
6. Earth's seasons are mainly caused by Earth's **tilted axis** as Earth **revolves** around the Sun.
...
17. The Northern Hemisphere is tilted most **toward** the Sun; it has its **longest day** and astronomical summer begins there (Southern Hemisphere has its shortest day and winter).
18. **Weather** is short-term atmospheric conditions; **climate** is the long-term average pattern of weather.
19. Accept reasonable answers, e.g., "Summer is because Earth is closer" is wrong; seasons are mainly from **tilt + revolution** changing sunlight angle and day length. Or: rotation alone does not cause seasons.
20. **Revolution** is Earth's orbital motion around the Sun; Earth takes about **365.25 days** for one revolution (one year).
...
4. **Day-Length Data Graph**
   Graph monthly daylight hours for a local or assigned city using almanac or online data. Identify longest/shortest days and connect to June and December solstices.

5. **Hemisphere Opposites Quick Quiz**
...
8. **Sports Season vs Astronomy Sort**
   Give cards with phrases (e.g., "playoff basketball," "longest day of the year," "league registration opens," "equinox"). Students sort into sports-season culture vs astronomical-season science and explain one card each.
