...
1. **Earth's rotation** is Earth's spin around its axis.
2. An **axis** is an imaginary line around which an object turns.
3. Earth takes about **24 hours** to rotate once (one solar day).
4. Day and night are caused by Earth's rotation. The side facing the Sun has day; the side turned away has night.
5. **Rotation** is spinning around an axis. **Revolution** is traveling around another object.
6. Earth's revolution around the Sun, together with Earth's tilted axis, helps cause the **year** and the **seasons**.
7. The **equator** is an imaginary line around Earth's middle, halfway between the poles. Places near the equator move faster because they travel a much larger circle during one rotation than places near the poles.
8. The Sun appears to rise in the east and set in the west because Earth rotates from **west to east**.
9. **Apparent motion** is motion as it appears from a certain point of view. Example: the Sun seeming to cross the sky daily while Earth rotates beneath us.
10. **Solar noon** is the time when the Sun is highest in the sky for that day.
11. We do not feel Earth spinning because Earth, the ground, air, oceans, buildings, and people move together at a steady rate. We notice changes in motion more than steady motion.
12. The atmosphere does not get left behind because it rotates with Earth, carried along by gravity, friction, and its long history of moving with the planet.
13. Stars appear to move across the sky at night mostly because **Earth rotates**.
14. **Star trails** are curved or circular streaks in long-exposure photos of stars. They show apparent motion caused by Earth's rotation.
15. **Polaris** is the North Star, useful because it lies close to the north celestial pole and helps observers find north. **No** — it is not the brightest star in the sky.
16. As Earth rotates, the Sun appears to move across the sky. Morning and afternoon shadows are usually longer; shadows near solar noon are usually shorter. Shadow direction shifts through the day.
17. A **sidereal day** is one rotation compared with distant stars (~23 h 56 min). A **solar day** is from one solar noon to the next (~24 h). The extra ~4 minutes per solar day is because Earth must rotate a bit more after one star-based spin so the Sun returns to the same noon position while Earth also orbits the Sun.
18. A **time zone** is a region that uses the same standard clock time. Earth rotates about **15 degrees** per hour.
19. **Longitude** tells how far east or west a place is from the prime meridian. Finding longitude at sea was difficult because sailors needed accurate time at a reference location to compare with local solar time, and reliable portable clocks were not always available.
...
1. **Lamp and Globe Day–Night Model**
   Use a bright lamp as the Sun and a globe as Earth. Rotate the globe west to east while a student marks one city with a sticker. Call out sunrise, midday, sunset, and night as the sticker moves into and out of light.
...
7. **Coriolis on a Turntable**
   Use a lazy Susan or rotating tray. Roll a marble outward while the tray spins; discuss apparent curve. Emphasize scale: this model helps intuition, but hurricanes need huge size and time — not bathroom sinks.
