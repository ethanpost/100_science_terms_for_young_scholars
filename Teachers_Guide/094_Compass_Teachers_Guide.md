...
1. A **compass** is a tool that uses Earth's magnetic field to help determine directions, especially north and south, and from those, east and west.
2. A **magnetized needle** (or an electronic magnetic sensor in digital compasses).
3. **North, east, south, west.**
4. The needle is a magnet in Earth's magnetic field. The north-seeking end aligns with the field direction that points generally toward the Arctic region. (Simplified classroom language: opposite magnetic poles attract; the needle's north end is pulled toward Earth's magnetic south pole, which lies near the geographic north polar region.)
5. **True north** is the direction toward the **North Pole** along Earth's rotation axis.
6. **Magnetic north** is the local direction indicated by a horizontal compass, defined by Earth's magnetic field rather than the rotation axis.
7. **Magnetic declination** is the angle between true north and magnetic north at a given location and time.
8. Accept any two reasonable examples: **steel or iron** (vehicles, fences, rebar), **magnets**, **electrical wires or devices**, **speakers**, **motors**, or holding the compass **tilted** or **moving** before the needle settles.
9. Maps are often drawn relative to **true north**. Compass readings follow **magnetic north**. Navigators apply declination to convert between map directions and compass directions so they do not walk off course.
10. Accept reasonable answers. Example: "A compass always points exactly at the geographic North Pole" is **false** because of **magnetic declination** and the difference between the magnetic and geographic poles.
...
14. A **map** shows where places and features are located. A **heading** (or bearing) is the **direction** you travel or face. A compass supplies heading information; a map supplies position and route context. Accept answers that capture this partnership.
15. Examples: **liquid-filled compass** — dampens needle bounce for hiking; **baseplate compass** — map work and orienteering with bearings; **lensatic compass** — sighting for military or survey work; **digital compass** — built into phones or GPS units. Accept any two valid types with a reasonable use.
16. Compasses allowed navigation **without landmarks** on open ocean or in poor weather. They worked without batteries or signals and helped explorers, traders, and navies cross vast distances.
17. **Orienteering** is a navigation sport in which participants use a **map and compass** to find control points along a planned course, usually in woods or parks, often timed as a race.
18. Accept sensible four-step summaries. A strong answer includes: place compass on map, line up edge from start to goal, rotate housing to match map north (with declination if needed), read bearing, then walk that bearing in the field while keeping the needle aligned.
...
5. **Map Bearings Practice**
   On a printed topo or park map, students use a baseplate compass (or a paper compass edge) to measure a bearing from one trail junction to another. Each student writes the bearing and describes what landmark they should reach if they walk it correctly.

6. **Orienteering Mini-Course**
   Set five control points (cones or flag cards) in a field or gym. Provide a simple map and compass headings between points. Teams race the course or complete it for accuracy. Emphasize leveling the compass and waiting for the needle to settle.
