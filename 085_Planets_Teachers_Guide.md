...
- Define a planet and explain the three main criteria used for planets in our solar system.
- Name the eight planets in order from the Sun.
- Explain that planets shine by reflected sunlight rather than by producing their own light.
- Distinguish planets from stars, moons, asteroids, and dwarf planets.
- Explain orbit, gravity, rotation, and revolution.
- Compare the rocky inner planets with the giant outer planets.
- Identify basic features of Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune.
...
1. A **planet** is a large, nearly round object that orbits a star and has cleared most other objects from its orbital path.
2. The eight planets in order from the Sun are Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus, and Neptune.
3. Planets shine because they reflect sunlight. They do not make their own light.
4. A star produces its own light and heat. A planet orbits a star and shines by reflected light.
5. In our solar system, a planet must orbit the Sun, be nearly round because of its own gravity, and have cleared most other objects from its orbital path.
6. Clearing its orbital path means the planet is gravitationally dominant in its orbital neighborhood. It has swept up, thrown away, or controlled most nearby objects.
7. An **orbit** is the path one object follows around another object in space.
8. Gravity pulls a planet inward toward the Sun while the planet's forward motion carries it onward. Together, these make a curved orbital path.
9. **Rotation** is spinning around an axis. **Revolution** is traveling around another object.
10. Day and night on Earth are caused by Earth's rotation.
11. A year on Earth is caused by Earth's revolution around the Sun, which takes about 365 days.
12. The inner planets are Mercury, Venus, Earth, and Mars.
13. The inner planets are called terrestrial planets because they are rocky, dense, and have solid surfaces.
14. The outer planets are Jupiter, Saturn, Uranus, and Neptune.
15. Gas giants, such as Jupiter and Saturn, are made mostly of hydrogen and helium. Ice giants, such as Uranus and Neptune, contain hydrogen and helium but also have more water, ammonia, methane, and similar materials.
16. Mercury has extreme hot and cold temperatures because it is close to the Sun and has almost no atmosphere to spread heat around or hold warmth.
17. Venus is hotter than Mercury because Venus has a very thick carbon dioxide atmosphere that traps heat in an extreme greenhouse effect.
...
25. Neptune has extremely strong winds, and it takes about 165 Earth years to orbit the Sun once.
26. An **atmosphere** is a layer of gases around a planet. It matters because it can trap heat, move heat, create weather, protect a surface, and strongly affect conditions on the planet.
27. **Moons** are natural satellites that orbit planets or dwarf planets.
28. Planetary rings are made of many small particles, often ice, rock, and dust, orbiting a planet.
29. Pluto is classified as a dwarf planet because it is round and orbits the Sun but has not cleared its orbital path.
30. An **exoplanet** is a planet outside our solar system that orbits another star.
